...
<div class="form-group">
 ...
 <!-- Text input-->
<div class="form-group">
  <label class="col-md-2 control-label" for="textinput">qual seu projeto?</label>  
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-8">
    ...
    Valor Pagar: <input type="text" name="peso_compra" value="1000"><br />   
    Nome Empresa: <input type="text" name="pagador_nome" value="Nome Sobrenome"><br /> 
    ...
    CNPJ: <input type="text" name="pagador_cpf" value="22222222222"><br />   
